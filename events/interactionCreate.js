    ...
    if (interaction.customId === "ian") {
      ...
      interaction.reply({
        ...
        ephemeral: true,
          ...
          if (interaction.customId === 'ap') interaction.reply({ content: `Esta parceria foi aceite por <@${interaction.member.id}>!` })
    if (interaction.customId === 'rp') interaction.reply({ content: `Esta parceria foi negada por <@${interaction.member.id}>!` })
  }
};
